...
class OnlineMAReversionStrategy(object):
    ...
    def _generateAllocations(self):
        ...
        # Create object:
        self.reversion_method = 1
        self.epsilon = 70
        self.window = 5
        self.alpha = 0.95
        self.PA_STRAT = OLMAR(reversion_method=self.reversion_method, epsilon=self.epsilon, window=self.window, alpha=self.alpha)
...
if __name__ == "__main__":
    ...
    OBJECT = OnlineMAReversionStrategy()
