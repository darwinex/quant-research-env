...
class SymmCorrNonparamLearnStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/PATTERN_MATCHING/SCORN/')
...
if __name__ == "__main__":
    ...
    OBJECT = SymmCorrNonparamLearnStrategy()
