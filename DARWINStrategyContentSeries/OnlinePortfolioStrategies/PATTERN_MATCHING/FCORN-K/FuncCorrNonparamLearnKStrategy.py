...
class FuncCorrNonparamLearnKStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/PATTERN_MATCHING/FCORN-K/')
    ...
    def _generateAllocations(self):
        ...
        self.lambd = 7
        self.k = 2
        self.PA_STRAT = FCORNK(window=self.window, rho=self.rho, lambd=self.lambd, k=self.k)
...
if __name__ == "__main__":
    ...
    OBJECT = FuncCorrNonparamLearnKStrategy()
