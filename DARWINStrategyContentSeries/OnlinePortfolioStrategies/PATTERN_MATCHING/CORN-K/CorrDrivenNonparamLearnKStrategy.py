...
class CorrDrivenNonparamLearnKStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/PATTERN_MATCHING/CORN-K/')
    ...
    def _generateAllocations(self):
        ...
        self.rho = 5
        self.k = 2
        self.PA_STRAT = CORNK(window=self.window, rho=self.rho, k=self.k)
...
if __name__ == "__main__":
    ...
    OBJECT = CorrDrivenNonparamLearnKStrategy()
