...
class UniversalPortfolioStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/UNIVERSAL_PORTFOLIO/UP/')
    ...
    def _generateAllocations(self):
        ...
        # Create object:
        self.number_of_experts = 100
        self.weighted = 'top-k' # 'uniform', 'hist_performance'
        self.k = 5
        self.PA_STRAT = UP(number_of_experts=self.number_of_experts, weighted=self.weighted, k=self.k)
...
if __name__ == "__main__":
    ...
    OBJECT = UniversalPortfolioStrategy()
