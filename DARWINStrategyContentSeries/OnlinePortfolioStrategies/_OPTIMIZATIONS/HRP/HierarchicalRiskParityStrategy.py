...
from mlfinlab.portfolio_optimization import *

class HierarchicalRiskParityStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/_OPTIMIZATIONS/HRP/')
    ...
    def _generateAllocations(self):
        ...
        # Create object:
        self.STRATEGY = HierarchicalRiskParity()
...
if __name__ == "__main__":
    ...
    OBJECT = HierarchicalRiskParityStrategy()
