...
class FollowTheLeaderStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/MOMEMTUM/FTL/')
...
if __name__ == "__main__":
    ...
    OBJECT = FollowTheLeaderStrategy()
