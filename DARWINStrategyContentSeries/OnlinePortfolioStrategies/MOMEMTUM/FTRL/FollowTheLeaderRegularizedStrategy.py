...
class FollowTheLeaderRegularizedStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/Darwinex/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/MOMEMTUM/FTRL/')
    ...
    def _generateAllocations(self):
        ...
        # Create object:
        '''High β : Aggressively follow the best performing asset.
           Low β : Passively follow the best performing asset. Strategy becomes a CRP with the given user weights and CRP-Uniform if no weights are given.'''
        self.beta = 0.3
        self.PA_STRAT = FTRL(beta=self.beta)
    ...
    def _plotPortfolioReturn(self):
        ...
        ax.legend(loc='best')
        plt.title(f'Portfolio returns for {self.PA_STRAT.__class__.__name__} strategy with beta of {self.beta}')
...
if __name__ == "__main__":
    ...
    OBJECT = FollowTheLeaderRegularizedStrategy()
