...
class BestConstantRebalancedPortfolioStrategy(object):
    ...
    def __init__(self):
        ...
        self.saveDirectory = os.path.expandvars('${HOME}/Desktop/quant-research-env/DARWINStrategyContentSeries/OnlinePortfolioStrategies/BENCHMARKS/BCRP/')
...
if __name__ == "__main__":
    ...
    OBJECT = BestConstantRebalancedPortfolioStrategy()
