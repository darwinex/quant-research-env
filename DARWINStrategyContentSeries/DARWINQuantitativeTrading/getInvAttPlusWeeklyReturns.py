...
class QuantitativeDarwinAnalysis(object):
    ...
    def _getDarwinClosesDataFrame(self, response, darwinSymbol):
        ...
        # Save it to csv:
        DF_RETURNS.to_csv(f'{self.homeStr}/Desktop/Darwinex/quant-research-env/DARWINStrategyContentSeries/DARWINQuantitativeTrading/Data/Weekly/returnsData_{darwinSymbol[0]}.csv')
    ...
    def _generateAnalysis(self, historicalDarwinScores):
        ...
        for eachDarwin, eachScoresDf in historicalDarwinScores.items():
            ...
            eachScoresDf = eachScoresDf.resample('W').last().dropna()
            ...
            for eachColumn in eachScoresDf:
                ...
                #dataFrameReturns[f'{eachColumn}_returns'] = eachScoresDf[eachColumn].pct_change()

            # Save it to csv:
            dataFrameReturns.to_csv(f'{self.homeStr}/Desktop/Darwinex/quant-research-env/DARWINStrategyContentSeries/DARWINQuantitativeTrading/Data/Weekly/scoresData_{eachDarwin}.csv')
    ...
    def _plotInvAttsAndDarwinReturns(self, darwinString, invAttDataframe, showIt=True):
        ...
        for eachAttributeName in invAttDataframe.columns:
            ...
            plt.plot(CLOSE_DF[f'{darwinString}_returns'], label=f'Weekly Returns {darwinString}')
            ...
            # In PNG:
            filePath = f'{self.homeStr}/Desktop/Darwinex/quant-research-env/DARWINStrategyContentSeries/DARWINQuantitativeTrading/Plots/Weekly/'
    ...
    def _createCandlePortfolio(self, symbol):
        ...
        RETURNED_RESPONSE = self.INFO_API._Get_DARWIN_OHLC_Candles_(_symbols=symbol,
                                                                    _resolution='1w', # 1m, 5m, 15m, 30m, 1h, 4h, 1d, 1w, 1mn
                                                                    _from_dt='',
